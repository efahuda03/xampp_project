...
<html>
	...
	<body>
		<h1>THE <p style="color: #e6b800; display: inline;">PACIFIC</p> HOTEL</h1>
		<ul>
		...
		<div class="row">
  			...
  			<div class="column">
    			<img src="images/4.jpeg" alt="Mountains" style="width:490px; height:235px">
  			</div>
		</div><br>
		<div class="row">
  			<div class="column">
		...
		<div class="basic_box">
			<div class="row">
  				<div class="column">
    				<img src="images/4.jpeg" alt="Snow" style="width:100%">
  				</div>
  				<div class="column">
    				<img src="images/6.jpeg" alt="Forest" style="width:300px; height:210px">
  				</div>
  				<div class="column">
		...
		<div id="contact" class="footer">
			...
			<h3 class="foot-text">CALL : 1 300 88 5285</h3><br>
		</div>
	</body>